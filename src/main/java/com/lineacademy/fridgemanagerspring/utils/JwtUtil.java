...
@Component      // 이 클래스를 Spring Boot에 Bean으로 등록한다는 어노테이션
// Bean : Spring이 직접 생성하고 관리하는 자바 객체를 뜻함
// 원래 클래스라면, 개발자가 생성하고(new JstUtil()) 관리(사ㅏ용)해야 되는데
...
public class JwtUtil {
    ...
    public String generateToken(Long userId) {
        return Jwts.builder().claim("id", userId)   // 암호화할 객체의 값을 넣는 메서드
                ...
                .signWith(key)      // 토큰에 입력받은 secretKey를 보안 키로
                .compact();         // 계약
    }
