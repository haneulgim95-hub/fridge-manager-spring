...
// Entry 타입의 객체를 그대로 내뱉는 것 자체에도 에러가 발생될 여지가 있긴 하지만,
// 특히, "password"처럼 response에 포함하지 말아야 되는 정보들을 걸러내기 위해
// response에도 DTO를 이용함
@Getter
@Builder
public class UserResponse {
    ...
    // from 메서드를 쓰면 User 타입의 객체를 받아, UserResponse의 객체로 변환하여 리턴
